...
__all__ = [ 'OLE_OPTEXCLUSIVE', 'OLE_YPOS_HIMETRIC', 'IPictureDisp',
           'OLE_YSIZE_CONTAINER', 'Color', 'OLE_CANCELBOOL',
           'FONTITALIC', 'StdPicture', 'FONTBOLD',
           'OLE_YSIZE_HIMETRIC', 'Monochrome', 'FONTSIZE', 'Font',
           'StdFont', 'OLE_XPOS_CONTAINER', 'OLE_HANDLE',
           'OLE_YSIZE_PIXELS', 'IFont', 'Picture', 'VgaColor',
           'FontEvents', 'OLE_XSIZE_PIXELS', 'FONTNAME', 'OLE_COLOR',
           'OLE_YPOS_CONTAINER', 'Gray', 'IFontEventsDisp',
           'OLE_YPOS_PIXELS', 'Checked', 'IFontDisp',
           'OLE_ENABLEDEFAULTBOOL', 'Unchecked', 'OLE_TRISTATE',
           'IPicture', 'OLE_XPOS_PIXELS', 'FONTUNDERSCORE',
           'FONTSTRIKETHROUGH', 'OLE_XSIZE_CONTAINER', 'Default',
